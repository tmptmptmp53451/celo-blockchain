...
//   - Grab the latest Go plugin `go get -u github.com/tmptmptmp53451/protobuf/protoc-gen-go`
//   - Vendor in the latest Go plugin `govendor fetch github.com/tmptmptmp53451/protobuf/...`
