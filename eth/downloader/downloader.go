...
func (d *Downloader) fetchBodies(from uint64) error {
	...
	var (
		deliver = func(packet dataPack) (int, error) {
			...
			return d.queue.DeliverBodies(pack.peerID, pack.randomness, pack.newSealedRandomness, pack.transactions, pack.uncles)
		}
...
func (d *Downloader) commitPivotBlock(result *fetchResult) error {
	block := types.NewBlockWithHeader(result.Header).WithBody(result.Randomness, result.NewSealedRandomness, result.Transactions, result.Uncles)
