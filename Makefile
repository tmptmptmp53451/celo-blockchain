...
ifeq ("$(RUSTUP_exists)","")
	...
	PATH="$$PATH:$(ANDROID_NDK)/toolchains/llvm/prebuilt/$(OS)-x86_64/bin:$(ANDROID_NDK)/toolchains/arm-linux-androideabi-4.9/prebuilt/$(OS)-x86_64/bin"; ln -s $(ANDROID_NDK)/toolchains/llvm/prebuilt/$(OS)-x86_64/bin/armv7a-linux-androideabi28-clang $(ANDROID_NDK)/toolchains/llvm/prebuilt/$(OS)-x86_64/bin/arm-linux-androideabi-clang; cd vendor/github.com/celo-org/bls-zexe/bls && cargo build --release --target=armv7-linux-androideabi --lib
