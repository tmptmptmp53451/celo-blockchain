...
import (
	...
	"github.com/tmptmptmp53451/celo-blockchain/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/tmptmptmp53451/celo-blockchain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	build.MustRun(goTool("get", "golang.org/x/mobile/cmd/gomobile", "golang.org/x/mobile/cmd/gobind"))
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/tmptmptmp53451/celo-blockchain/mobile")
